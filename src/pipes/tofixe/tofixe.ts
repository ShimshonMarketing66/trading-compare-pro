    ...
    if (num < 100) {
      if (num < 10) {
        if (num < 1) {
          ...
          return isPositive ? Number(num.toFixed(3)) : Number(num.toFixed(4)) * -1
        }
        return isPositive ? Number(num.toFixed(2)) : Number(num.toFixed(3)) * -1
      }
      return isPositive ? Number(num.toFixed(1)) : Number(num.toFixed(2)) * -1
    }
    if (num > 10000) {
