...
export class Tofixed_4Pipe implements PipeTransform {
  transform(num: number, ...args) {    
    ...
    if (num < 100) {
                            ...
                            if (num < 0.00000000001) {
                              if (num < 0.000000000001) {
                                if (num < 0.0000000000001) {
                                  return isPositive ? Number(num.toFixed(18)) : Number(num.toFixed(18)) * -1
                                }
                                return isPositive ? Number(num.toFixed(17)) : Number(num.toFixed(17)) * -1
                              }
                              return isPositive ? Number(num.toFixed(16)) : Number(num.toFixed(16)) * -1
                            }
                            return isPositive ? Number(num.toFixed(15)) : Number(num.toFixed(15)) * -1
                          }
      ...
      return isPositive ? Number(num.toFixed(1)) : Number(num.toFixed(4)) * -1
    }
    if (num > 10000) {
